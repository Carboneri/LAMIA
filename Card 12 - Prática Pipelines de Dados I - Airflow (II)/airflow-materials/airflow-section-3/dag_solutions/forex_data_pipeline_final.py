...
# token vem de env var em vez de ficar escrito no código (evita vazar
# credencial real caso o repositório seja público)
SLACK_TOKEN = os.environ.get("SLACK_TOKEN") or "xoxp-configure-SLACK_TOKEN-no-ambiente"
